...
const DEFAULT_PREFIX = `You are Shlomo Code, a local LLM-powered CLI assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Shlomo Code, a local LLM-powered CLI assistant, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Shlomo agent, built on the Claude Agent SDK.`
