...
import { getSpeechToTextConfigurationError } from '../../services/stt/provider.js';
...
function _temp() {
  return isVoiceModeEnabled() && getSpeechToTextConfigurationError() === null && getInitialSettings().voiceEnabled !== true && (getGlobalConfig().voiceNoticeSeenCount ?? 0) < MAX_SHOW_COUNT && !shouldShowOpus1mMergeNotice();
}
