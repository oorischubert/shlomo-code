...
import { formatDisplayModelCapabilities } from './model/modelCapabilitiesDisplay.js';
...
export function getModelDisplayLabel(mainLoopModel: string | null): React.ReactNode {
...
export function getModelCapabilitiesLabel(
  mainLoopModel: string | null,
): React.ReactNode | null {
  if (!formatDisplayModelCapabilities(mainLoopModel)) {
    return null;
  }
  return <ModelCapabilityBadges model={mainLoopModel} />;
}
