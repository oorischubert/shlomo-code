...
function tokensToUSDCost(modelCosts: ModelCosts, usage: Usage): number {
  ...
  return (
    (normalizedUsage.input_tokens / 1_000_000) * modelCosts.inputTokens +
    (normalizedUsage.output_tokens / 1_000_000) * modelCosts.outputTokens +
    ((normalizedUsage.cache_read_input_tokens ?? 0) / 1_000_000) *
      modelCosts.promptCacheReadTokens +
    ((normalizedUsage.cache_creation_input_tokens ?? 0) / 1_000_000) *
...
export function getModelCosts(model: string, usage: Usage): ModelCosts {
  ...
  if (
    ...
    const isFastMode = normalizedUsage?.speed === 'fast'
